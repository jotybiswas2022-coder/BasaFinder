...
<form method="POST" action="{{ route('admin.users.store') }}" class="tf-card tl-animate" style="animation-delay:0.1s">
    @csrf
    ...
    <div class="tf-group">
        ...
        <input type="text" id="password" name="password" placeholder="Minimum 8 characters" required>
    </div>
    <div class="tf-group">
        <label for="password_confirmation">Confirm Password</label>
        <input type="text" id="password_confirmation" name="password_confirmation" placeholder="Re-enter password" required>
    </div>
